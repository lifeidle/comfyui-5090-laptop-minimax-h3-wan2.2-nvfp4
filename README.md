...
| **视频（质量优先）** | **Wan 2.2 14B MoE + 4步 LoRA** | **93.8 s** @832×480/81帧 | 旗舰 MoE 画质；4 步比 20 步**快 7.9×**（20 步要 739 s，不值） |
| 视频（速度优先） | LTX-Video 2B 蒸馏 | **19.2 s** @1216×704/121帧 | 比 Wan 14B 快 4.9×；接受运动幅度小 |
| **视频 + 音频** | **MiniMax H3 + 4步 LoRA** | **286.2 s** | 4 步比 8 步**快 1.81×**；唯一原生出音轨 |
...
| 模型 | 授权 | 能否商用 | 备注 |
|---|---|---|---|
| **Qwen-Image 2512** | Apache 2.0 | ✅ | §11 的图像首选，授权干净 |
| **Wan 2.2（5B / 14B）** | Apache 2.0 | ✅ | §11 的视频首选，授权干净 |
| **ACE-Step 1.5** | Apache 2.0 | ✅ | §11 的音乐首选，授权干净 |
...
| MiniMax Music 3 | 见官方仓库 | ⚠️ 未核实 | 用前必须自查 |
| MiniMax H3 | 见官方仓库 | ⚠️ 未核实 | 用前必须自查 |
| Stable Audio 3 Medium | 见官方仓库 | ⚠️ 未核实 | Stability 系社区授权通常有营收门槛 |
| Lens / ERNIE-Image | 见官方仓库 | ⚠️ 未核实 | 较新，条款以模型卡为准 |
